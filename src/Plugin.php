...
class Plugin
{
	...
	public static function getRequirements(GenericEvent $event)
	{
		...
		$loader->add_requirement('class.Googlewallet', '/../vendor/detain/googlewallet-payments/src/Googlewallet.php');
		$loader->add_requirement('deactivate_kcare', '/../vendor/detain/googlewallet-payments/src/abuse.inc.php');
		$loader->add_requirement('deactivate_abuse', '/../vendor/detain/googlewallet-payments/src/abuse.inc.php');
		$loader->add_requirement('get_abuse_licenses', '/../vendor/detain/googlewallet-payments/src/abuse.inc.php');
	}
